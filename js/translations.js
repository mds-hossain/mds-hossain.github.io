...
window.TRANSLATIONS = {
  ...
  en: {
    ...
    sec_certs_label:          "Credentials",
    sec_certs_title:          "Certifications",
    sec_certs_sub:            "Continuously upskilling across AI, testing, UX, agile, and digital strategy.",
    sec_pub_label:            "Research",
    sec_pub_title:            "Publication",
    sec_pub_sub:              "Peer-reviewed research at the intersection of HCI, sustainability, and global design education.",
    sec_leadership_label:     "Beyond Work",
    sec_leadership_title:     "Leadership and ECA",
    sec_leadership_sub:       "A long track record of international leadership, MUN, and community contribution across five continents.",
    ...
    sec_orgs_label:           "Membership",
    sec_orgs_title:           "Organizations",
    sec_orgs_sub:             "Active member of international professional, academic, and social innovation organizations.",
  ...
  de: {
    ...
    sec_certs_label:          "Nachweise",
    sec_certs_title:          "Zertifikate",
    sec_certs_sub:            "Kontinuierliche Weiterbildung in KI, Testing, UX, Agile und digitaler Strategie.",
    sec_pub_label:            "Forschung",
    sec_pub_title:            "Publikation",
    sec_pub_sub:              "Begutachtete Forschung an der Schnittstelle von HCI, Nachhaltigkeit und globaler Designausbildung.",
    sec_leadership_label:     "Engagement",
    sec_leadership_title:     "Fuehrung und ECA",
    sec_leadership_sub:       "Langjaerige internationale Fuehrungserfahrung, MUN und Gemeinschaftsbeitrag auf fuenf Kontinenten.",
    ...
    sec_orgs_label:           "Mitgliedschaft",
    sec_orgs_title:           "Organisationen",
    sec_orgs_sub:             "Aktives Mitglied internationaler professioneller, akademischer und sozialer Innovationsorganisationen.",
